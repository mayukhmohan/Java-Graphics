...
public class emoji extends Applet implements ActionListener , MouseListener, MouseMotionListener
{
    ...
    public void paint(Graphics g) {
        ...
        if(s1.equalsIgnoreCase("happy"))
        {
            happy(g);
        }
        else if(s1.equalsIgnoreCase("upset"))
        {
            upset(g);
        }
        else if(s1.equalsIgnoreCase("angry"))
        {
            angry(g);
        }
        else if(s1.equalsIgnoreCase("cunning"))
        {
            cunning(g);
        }
        else if(s1.equalsIgnoreCase("fearful"))
        {
            fearful(g);
        }
        else if(s1.equalsIgnoreCase("surprized"))
        {
            surprized(g);
        }
        else if(s1.equalsIgnoreCase("sad"))
        {
            sad(g);
        }
        else
