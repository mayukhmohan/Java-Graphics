...
public class butterfly_old extends Applet implements ActionListener, MouseListener, MouseMotionListener
    {
        ...
        public void butterfly(Graphics g)
        {
            Graphics2D g2d = (Graphics2D)g;
            g2d = (Graphics2D)g.create();
            g2d.translate(0,-100);
            midpointEllipse(g,0*k,16*k,3*k,3*k);
            g2d.translate(0,-100);
            midpointEllipse(g,0*k,10*k,3*k,3*k);
            g2d.translate(0,-100);
            midpointEllipse(g,0*k,4*k,3*k,3*k);
            g2d.translate(100,-100);
            midpointEllipse(g,0*k,-2*k,3*k,3*k);
            g2d.translate(0,-100);
            midpointEllipse(g,0*k,-8*k,3*k,3*k);
            g2d.translate(0,-100);
            midpointEllipse(g,0*k,-14*k,3*k,3*k);
            g2d = (Graphics2D)g.create();
            g2d.translate(0,-100);
            g2d.rotate(Math.toRadians(-45));
            midpointEllipse(g2d,1*k,15*k,6*k,12*k);
            g2d = (Graphics2D)g.create();
            g2d.translate(0,-100);
            g2d.rotate(Math.toRadians(45));
            midpointEllipse(g2d,-1*k,15*k,6*k,12*k);
            ...
            g2d.translate(0,-100);
            g2d.rotate(Math.toRadians(45));
            midpointEllipse(g2d,1*k,-14*k,6*k,12*k);
            g2d = (Graphics2D)g.create();
            g2d.translate(0,-100);
            g2d.rotate(Math.toRadians(-45));
            midpointEllipse(g2d,-1*k,-14*k,6*k,12*k);
            ...
            g2d = (Graphics2D)g.create();
            arr5.add(new Pair <Integer, Integer> (-5*k,-18*k));
            arr5.add(new Pair <Integer, Integer> (5*k, -18*k));
            arr5.add(new Pair <Integer, Integer> (5*k, -28*k));
            arr5.add(new Pair <Integer, Integer> (-5*k, -28*k));
            arr5.add(new Pair <Integer, Integer> (-5*k,-18*k));
            g2d.translate(0,-100);
            draw(g,arr5);
            g2d = (Graphics2D)g.create();
            g2d.translate(0,-100);
            DDA(g,-5*k,-28*k,-20*k,-48*k);
            g2d = (Graphics2D)g.create();
            g2d.translate(0,-100);
            DDA(g,5*k,-28*k,20*k,-48*k);
            g2d = (Graphics2D)g.create();
            g2d.translate(0,-100);
            midpointEllipse(g,-20*k,-48*k,2*k,2*k);
            g2d = (Graphics2D)g.create();
            g2d.translate(0,-100);
            midpointEllipse(g,20*k,-48*k,2*k,2*k);
            g2d.dispose();
