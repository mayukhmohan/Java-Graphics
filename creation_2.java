...
public class creation_2 extends Applet implements Runnable , ActionListener , MouseListener, MouseMotionListener
{
    int width=getWidth();
    int height=getWidth();
    int frameNumber = -1;
    ...
    int bx = 0, by = 0, hx = 0, hy = 0, rx = 0, ry = 0, br = 200;
    int ea = 200, eb = 20;
    int stepSize = 5;
    int j = stepSize;
    ...
    public void run() {
        ...
        while (true) {
            ...
            if(x_dist > getWidth()/2 || r_dist > getWidth()/2)
            {
                up = true;
            }
